...
public class CashRegisterInputParser {
    ...
    public Map<String, PurchasedGoods> getAllPurchasedGoods() throws Exception {
        ...
        Map<String, PurchasedGoods> purchasedGoodsMap = newHashMap();
    ...
    private void initPurchasedGoods(Map<String, PurchasedGoods> purchasedGoodsMap, String key, int addedCount) throws Exception {
